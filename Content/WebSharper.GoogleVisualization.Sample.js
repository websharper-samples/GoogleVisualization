...
{
 "use strict";
 var Global,WebSharper,GoogleVisualization,Sample,Client,Operators,Google,Visualization,BarChartOptions,UI,AttrModule,Obj,Client$1,Templates,Doc,JavaScript,Pervasives,AttrProxy,EventTarget,Node,JS,Collections,Dictionary,DomUtility,Unchecked,SC$1,Arrays,HashSet,Seq,WindowOrWorkerGlobalScope,View,SC$2,Docs,Elt,Array,DictionaryUtil,Object,Prepare,Slice,Enumerator,KeyCollection,DocElemNode,CharacterData,An,Settings,Abbrev,Mailbox,Updates,Attrs,List,T,Strings,Attrs$1,Dyn,Docs$1,RunState,NodeSet,Snap,Anims,SC$3,Fresh,SC$4,T$1,SC$5,Concurrency,AppendList,Easing,AsyncBody,SC$6,CT,HashSet$1,HashSetUtil,SC$7,Scheduler,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$8,Queue,LazyExtensionsProxy,LazyRecord,google,visualization,IntelliFactory,Runtime,console,$,Date;
 Global=self;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 GoogleVisualization=WebSharper.GoogleVisualization=WebSharper.GoogleVisualization||{};
 Sample=GoogleVisualization.Sample=GoogleVisualization.Sample||{};
 ...
 {
  var a;
  a=Doc.Element("div",[AttrModule.OnAfterRender(function(container)
  {
   var visualization$1,options,r,r$1;
   visualization$1=new visualization.BarChart(container);
   options=(r={},r.height=400,r.legend=(r$1={},r$1.position="bottom",r$1),r.title="Company Performance",r);
   visualization$1.draw(Client.AreaChartData(),options);
  })],[]);
  Templates.LoadLocalTemplates("");
  Doc.RunById("main",a);
 };
 Client.AreaChartData=function()
 {
  var data;
